...
public class VideoActivity extends AppCompatActivity {
    ...
    private void populateData() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final ArrayList<HashMap<String, String>> reqVideo = RequestLoadVideo(limit_bottom,limit_top);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final ArrayList<HashMap<String, String>> reqVideo = RequestLoadVideo(String.valueOf(limit_bottom_new), String.valueOf(limit_top_new));
    ...
    private ArrayList<HashMap<String, String>> RequestLoadVideo(String limit_bottom, String limit_top) {
