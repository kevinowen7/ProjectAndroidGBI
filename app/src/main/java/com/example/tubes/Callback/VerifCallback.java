...
public class VerifCallback extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public VerifCallback(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        paramsed.add(new BasicNameValuePair("code", params[0]));
        paramsed.add(new BasicNameValuePair("email", params[1]));
        ...
        try {
            //call http
            JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1317016/verif_password.php",
                    "POST", paramsed);
