...
public class ForgotCallback extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public ForgotCallback(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        paramsed.add(new BasicNameValuePair("data", params[0])); //nama
        ...
        try {
            //call http
            JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1317016/forgot_password.php",
                    "POST", paramsed);
